...
import cms.pnl.Pnl_Dashboard;
import cms.settings.Settings;
import cms.util.Center;
...
public class MyMain {
    ...
    private static void ret_config() {
        String home = System.getProperty("user.home") + "\\my_config_clinic.conf";
        ...
        try {
            ...
            System.setProperty("pool_db", prop.getProperty("pool_db", "db_clinic"));
            System.setProperty("environment", prop.getProperty("environment", "production"));
            System.setProperty("time_slots", prop.getProperty("time_slots", ""));
            System.setProperty("uoms", prop.getProperty("uoms", ""));
...
//            System.out.println("inventory_item_delete: " + System.getProperty("inventory_item_delete"));
            ...
            if (setting.receipt_print_ting_enabled == 1) {
...
//            System.setProperty("drawer", setting.drawer);
            ...
            System.setProperty("cloud_db", prop.getProperty("cloud_db", "db_clinic"));
    ...
    private void start() {
        ...
        Image image = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/cms/icons/stock_status.png"));
