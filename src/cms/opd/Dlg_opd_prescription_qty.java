 ...
 */
public class Dlg_opd_prescription_qty extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_opd_prescription_qty
     */
    ...
    public static class OutputData {
        ...
        public OutputData(double qty, String dosage, int days, double dosage_qty, String dosage_remarks, String remarks) {
            this.qty = qty;
            this.dosage = dosage;
            this.days = days;
...
//</editor-fold>
    ...
    private Dlg_opd_prescription_qty(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_opd_prescription_qty(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_opd_prescription_qty() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_opd_prescription_qty myRef;

    private void setThisRef(Dlg_opd_prescription_qty myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_opd_prescription_qty> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_opd_prescription_qty create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_opd_prescription_qty create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_opd_prescription_qty dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_opd_prescription_qty((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_opd_prescription_qty((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_opd_prescription_qty dialog = Dlg_opd_prescription_qty.create(new javax.swing.JFrame(), true);
    ...
    public void do_pass(double qty) {
        jTextField2.setText(FitIn.fmt_wc_0(qty));
    }
...
//                btn_0.doClick();
    ...
    private void ok() {
        ...
        if (callback != null) {
            callback.ok(new CloseDialog(this), new OutputData(qty, dosage, days, dosage_qty, dosage_remarks, remarks));
        }
    }
}
