 ...
 */
public class Dlg_option_investigation extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_option_investigation(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_option_investigation(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_option_investigation() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_option_investigation myRef;

    private void setThisRef(Dlg_option_investigation myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_option_investigation> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_option_investigation create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_option_investigation create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_option_investigation dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_option_investigation((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_option_investigation((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_option_investigation dialog = Dlg_option_investigation.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    public static void loadData_option_investigation_category(List<Option_investigation_categories.to_option_investigation_categories> acc) {
    ...
    public static class Tbloption_investigation_categoryModel extends AbstractTableAdapter {
        ...
        public Object getValueAt(int row, int col) {
            Option_investigation_categories.to_option_investigation_categories tt = (Option_investigation_categories.to_option_investigation_categories) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.category;
                case 1:
    ...
    private void ret_investigation_categories() {
        ...
        List<Option_investigation_categories.to_option_investigation_categories> datas = Option_investigation_categories.ret_data(where);
    ...
    private void new_investigation_category() {
        ...
        nd.setCallback(new Dlg_option_new.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                ...
                int status = 0;
                int is_uploaded = 0;
                Option_investigation_categories.to_option_investigation_categories comp = new Option_investigation_categories.to_option_investigation_categories(id, category, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                Option_investigation_categories.add_data(comp);
                ret_investigation_categories();
                Alert.set(1, "");
            }
        });
    ...
    private void select_investigation_category() {
        ...
        Option_investigation_categories.to_option_investigation_categories to = (Option_investigation_categories.to_option_investigation_categories) tbl_option_investigation_category_ALM.get(row);
        ...
        if (col == 1) {
            ...
            nd.setCallback(new Dlg_option_new.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                    ...
                    int is_uploaded = 0;
                    Option_investigation_categories.to_option_investigation_categories comp = new Option_investigation_categories.to_option_investigation_categories(id, category, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                    Option_investigation_categories.update_data(comp);
                    ret_investigation_categories();
                    Alert.set(2, "");
                }
            });
        ...
        if (col == 2) {
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Option_investigation_categories.delete_data(to);
                    ret_investigation_categories();
                    Alert.set(3, "");
                }
            });
...
//</editor-fold> 
    ...
    public static void loadData_option_investigation_details(List<Option_investigation_details.to_option_investigation_details> acc) {
    ...
    public static class Tbloption_investigation_detailsModel extends AbstractTableAdapter {
        ...
        @Override
        public Object getValueAt(int row, int col) {
            Option_investigation_details.to_option_investigation_details tt = (Option_investigation_details.to_option_investigation_details) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.details;
                case 1:
    ...
    private void ret_investigation_details() {
        ...
        List<Option_investigation_details.to_option_investigation_details> datas = Option_investigation_details.ret_data(where);
    ...
    private void new_investigation_detail() {
        ...
        nd.setCallback(new Dlg_option_new.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                ...
                int status = 0;
                int is_uploaded = 0;
                Option_investigation_details.to_option_investigation_details comp = new Option_investigation_details.to_option_investigation_details(id, category, category_id, details, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                Option_investigation_details.add_data(comp);
                ret_investigation_details();
                Alert.set(1, "");
            }
        });
    ...
    private void select_investigation_details() {
        ...
        Option_investigation_details.to_option_investigation_details to = (Option_investigation_details.to_option_investigation_details) tbl_option_investigation_details_ALM.get(row);
        ...
        if (col == 1) {
            ...
            nd.setCallback(new Dlg_option_new.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                    ...
                    int is_uploaded = 0;
                    Option_investigation_details.to_option_investigation_details comp = new Option_investigation_details.to_option_investigation_details(id, category, category_id, details, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                    Option_investigation_details.update_data(comp);
                    ret_investigation_details();
                    Alert.set(2, "");
                }
            });
        ...
        if (col == 2) {
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Option_investigation_details.delete_data(to);
                    ret_investigation_details();
                    Alert.set(3, "");
                }
            });
...
//</editor-fold> 
    private void add_investigation() {
        ...
        Option_investigation_details.to_option_investigation_details sub = (Option_investigation_details.to_option_investigation_details) tbl_option_investigation_details_ALM.get(row);
