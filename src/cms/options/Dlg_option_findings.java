 ...
 */
public class Dlg_option_findings extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_option_findings(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_option_findings(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_option_findings myRef;

    private void setThisRef(Dlg_option_findings myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_option_findings> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_option_findings create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_option_findings create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_option_findings dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_option_findings((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_option_findings((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_option_findings dialog = Dlg_option_findings.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    //<editor-fold defaultstate="collapsed" desc=" option findings category "> 
    ...
    public static void loadData_option_history_group(List<Option_findings_categories.to_option_findings_categories> acc) {
    ...
    public static class Tbloption_history_groupModel extends AbstractTableAdapter {
        ...
        public Object getValueAt(int row, int col) {
            Option_findings_categories.to_option_findings_categories tt = (Option_findings_categories.to_option_findings_categories) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.category;
                case 1:
    ...
    private void ret_history_category() {
        ...
        List<Option_findings_categories.to_option_findings_categories> datas = Option_findings_categories.ret_data(where);
    ...
    private void new_history_category() {
        ...
        nd.setCallback(new Dlg_option_new.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                ...
                int status = 0;
                int is_uploaded = 0;
                Option_findings_categories.to_option_findings_categories comp = new Option_findings_categories.to_option_findings_categories(id, category, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                Option_findings_categories.add_data(comp);
                ret_history_category();
                Alert.set(1, "");
            }
        });
    ...
    private void select_history_category() {
        ...
        Option_findings_categories.to_option_findings_categories to = (Option_findings_categories.to_option_findings_categories) tbl_option_history_group_ALM.get(row);
        ...
        if (col == 1) {
            ...
            nd.setCallback(new Dlg_option_new.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                    ...
                    int is_uploaded = 0;
                    Option_findings_categories.to_option_findings_categories comp = new Option_findings_categories.to_option_findings_categories(id, category, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                    Option_findings_categories.update_data(comp);
                    ret_history_category();
                    Alert.set(2, "");
                }
            });
        ...
        if (col == 2) {
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Option_findings_categories.delete_data(to);
                    ret_history_category();
                    Alert.set(3, "");
                }
            });
...
//</editor-fold> 
    //<editor-fold defaultstate="collapsed" desc=" option findings classification "> 
    ...
    public static void loadData_option_history_classification(List<Option_findings_classifications.to_option_findings_classifications> acc) {
    ...
    public static class Tbloption_history_classificationModel extends AbstractTableAdapter {
        ...
        @Override
        public Object getValueAt(int row, int col) {
            Option_findings_classifications.to_option_findings_classifications tt = (Option_findings_classifications.to_option_findings_classifications) getRow(row);
            switch (col) {
                case 0:
    ...
    private void ret_history_classification() {
        ...
        List<Option_findings_classifications.to_option_findings_classifications> datas = Option_findings_classifications.ret_data(where);
    ...
    private void new_history_classification() {
        ...
        nd.setCallback(new Dlg_option_new.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                ...
                int status = 0;
                int is_uploaded = 0;
                Option_findings_classifications.to_option_findings_classifications comp = new Option_findings_classifications.to_option_findings_classifications(id, category, category_id, classification, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                Option_findings_classifications.add_data(comp);
                ret_history_classification();
                Alert.set(1, "");
            }
        });
    ...
    private void select_history_classification() {
        ...
        Option_findings_classifications.to_option_findings_classifications to = (Option_findings_classifications.to_option_findings_classifications) tbl_option_history_classification_ALM.get(row);
        ...
        if (col == 1) {
            ...
            nd.setCallback(new Dlg_option_new.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                    ...
                    int is_uploaded = 0;
                    Option_findings_classifications.to_option_findings_classifications comp = new Option_findings_classifications.to_option_findings_classifications(id, category, category_id, classification, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                    Option_findings_classifications.update_data(comp);
                    ret_history_classification();
                    Alert.set(2, "");
                }
            });
        ...
        if (col == 2) {
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Option_findings_classifications.delete_data(to);
                    ret_history_classification();
                    Alert.set(3, "");
                }
            });
...
//</editor-fold> 
    ...
    public static void loadData_option_history_sub_classification(List<Option_findings_details.to_option_findings_details> acc) {
        tbl_option_history_sub_classification_ALM.clear();
    ...
    public static class Tbloption_history_sub_classificationModel extends AbstractTableAdapter {
        ...
        @Override
        public Object getValueAt(int row, int col) {
            Option_findings_details.to_option_findings_details tt = (Option_findings_details.to_option_findings_details) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.details;
                case 1:
    ...
    private void ret_history_sub_classification() {
        ...
        Option_findings_classifications.to_option_findings_classifications to = (Option_findings_classifications.to_option_findings_classifications) tbl_option_history_classification_ALM.get(row);
        String where = " where classification_id='" + to.id + "' and details like '%" + tf_search_patient2.getText() + "%' "
                + " order by details asc ";
        List<Option_findings_details.to_option_findings_details> datas = Option_findings_details.ret_data(where);
    ...
    private void new_history_sub_classification() {
        ...
        nd.setCallback(new Dlg_option_new.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                ...
                int status = 0;
                int is_uploaded = 0;
                Option_findings_details.to_option_findings_details comp = new Option_findings_details.to_option_findings_details(id, category, category_id, classification, classification_id, sub_classification, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                Option_findings_details.add_data(comp);
                ret_history_sub_classification();
                Alert.set(1, "");
            }
        });
    ...
    private void select_history_sub_classification() {
        ...
        Option_findings_details.to_option_findings_details to = (Option_findings_details.to_option_findings_details) tbl_option_history_sub_classification_ALM.get(row);
        ...
        if (col == 1) {
            ...
            nd.setCallback(new Dlg_option_new.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                    ...
                    int is_uploaded = 0;
                    Option_findings_details.to_option_findings_details comp = new Option_findings_details.to_option_findings_details(id, category, category_id, classification, classification_id, sub_classification, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                    Option_findings_details.update_data(comp);
                    ret_history_sub_classification();
                    Alert.set(2, "");
                }
            });
        ...
        if (col == 2) {
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Option_findings_details.delete_data(to);
                    ret_history_sub_classification();
                    Alert.set(3, "");
                }
            });
...
//</editor-fold> 
    private void add_history() {
        ...
        Option_findings_details.to_option_findings_details sub = (Option_findings_details.to_option_findings_details) tbl_option_history_sub_classification_ALM.get(row);
