 ...
 */
public class Dlg_option_diagnosis extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_option_diagnosis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_option_diagnosis(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_option_diagnosis myRef;

    private void setThisRef(Dlg_option_diagnosis myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_option_diagnosis> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_option_diagnosis create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_option_diagnosis create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_option_diagnosis dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_option_diagnosis((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_option_diagnosis((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_option_diagnosis dialog = Dlg_option_diagnosis.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    //<editor-fold defaultstate="collapsed" desc=" option diagnosis category "> 
    ...
    public static void loadData_option_history_group(List<Option_diagnosis_categories.to_option_diagnosis_categories> acc) {
    ...
    public static class Tbloption_history_groupModel extends AbstractTableAdapter {
        ...
        public Object getValueAt(int row, int col) {
            Option_diagnosis_categories.to_option_diagnosis_categories tt = (Option_diagnosis_categories.to_option_diagnosis_categories) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.category;
                case 1:
    ...
    private void ret_history_category() {
        ...
        List<Option_diagnosis_categories.to_option_diagnosis_categories> datas = Option_diagnosis_categories.ret_data(where);
    ...
    private void new_history_category() {
        ...
        nd.setCallback(new Dlg_option_new.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                ...
                int status = 0;
                int is_uploaded = 0;
                Option_diagnosis_categories.to_option_diagnosis_categories comp = new Option_diagnosis_categories.to_option_diagnosis_categories(id, category, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                Option_diagnosis_categories.add_data(comp);
                ret_history_category();
                Alert.set(1, "");
            }
        });
    ...
    private void select_history_category() {
        ...
        Option_diagnosis_categories.to_option_diagnosis_categories to = (Option_diagnosis_categories.to_option_diagnosis_categories) tbl_option_history_group_ALM.get(row);
        ...
        if (col == 1) {
            ...
            nd.setCallback(new Dlg_option_new.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                    ...
                    int is_uploaded = 0;
                    Option_diagnosis_categories.to_option_diagnosis_categories comp = new Option_diagnosis_categories.to_option_diagnosis_categories(id, category, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                    Option_diagnosis_categories.update_data(comp);
                    ret_history_category();
                    Alert.set(2, "");
                }
            });
        ...
        if (col == 2) {
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Option_diagnosis_categories.delete_data(to);
                    ret_history_category();
                    Alert.set(3, "");
                }
            });
...
//</editor-fold> 
    ...
    public static void loadData_option_history_classification(List<Option_diagnosis_classifications.to_option_diagnosis_classifications> acc) {
    ...
    public static class Tbloption_history_classificationModel extends AbstractTableAdapter {
        ...
        @Override
        public Object getValueAt(int row, int col) {
            Option_diagnosis_classifications.to_option_diagnosis_classifications tt = (Option_diagnosis_classifications.to_option_diagnosis_classifications) getRow(row);
            switch (col) {
                case 0:
    ...
    private void ret_history_classification() {
        ...
        List<Option_diagnosis_classifications.to_option_diagnosis_classifications> datas = Option_diagnosis_classifications.ret_data(where);
    ...
    private void new_history_classification() {
        ...
        nd.setCallback(new Dlg_option_new.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                ...
                int status = 0;
                int is_uploaded = 0;
                Option_diagnosis_classifications.to_option_diagnosis_classifications comp = new Option_diagnosis_classifications.to_option_diagnosis_classifications(id, category, category_id, classification, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                Option_diagnosis_classifications.add_data(comp);
                ret_history_classification();
                Alert.set(1, "");
            }
        });
    ...
    private void select_history_classification() {
        ...
        Option_diagnosis_classifications.to_option_diagnosis_classifications to = (Option_diagnosis_classifications.to_option_diagnosis_classifications) tbl_option_history_classification_ALM.get(row);
        ...
        if (col == 1) {
            ...
            nd.setCallback(new Dlg_option_new.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                    ...
                    int is_uploaded = 0;
                    Option_diagnosis_classifications.to_option_diagnosis_classifications comp = new Option_diagnosis_classifications.to_option_diagnosis_classifications(id, category, category_id, classification, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                    Option_diagnosis_classifications.update_data(comp);
                    ret_history_classification();
                    Alert.set(2, "");
                }
            });
        ...
        if (col == 2) {
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Option_diagnosis_classifications.delete_data(to);
                    ret_history_classification();
                    Alert.set(3, "");
                }
            });
...
//</editor-fold> 
    ...
    public static void loadData_option_history_sub_classification(List<Option_diagnosis_details.to_option_diagnosis_details> acc) {
        tbl_option_history_sub_classification_ALM.clear();
    ...
    public static class Tbloption_history_sub_classificationModel extends AbstractTableAdapter {
        ...
        @Override
        public Object getValueAt(int row, int col) {
            Option_diagnosis_details.to_option_diagnosis_details tt = (Option_diagnosis_details.to_option_diagnosis_details) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.details;
                case 1:
    ...
    private void ret_history_sub_classification() {
        ...
        List<Option_diagnosis_details.to_option_diagnosis_details> datas = Option_diagnosis_details.ret_data(where);
    ...
    private void new_history_sub_classification() {
        ...
        nd.setCallback(new Dlg_option_new.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                ...
                int status = 0;
                int is_uploaded = 0;
                Option_diagnosis_details.to_option_diagnosis_details comp = new Option_diagnosis_details.to_option_diagnosis_details(id, category, category_id, classification, classification_id, sub_classification, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                Option_diagnosis_details.add_data(comp);
                ret_history_sub_classification();
                Alert.set(1, "");
            }
        });
    ...
    private void select_history_sub_classification() {
        ...
        Option_diagnosis_details.to_option_diagnosis_details to = (Option_diagnosis_details.to_option_diagnosis_details) tbl_option_history_sub_classification_ALM.get(row);
        ...
        if (col == 1) {
            ...
            nd.setCallback(new Dlg_option_new.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_option_new.OutputData data) {
                    ...
                    int is_uploaded = 0;
                    Option_diagnosis_details.to_option_diagnosis_details comp = new Option_diagnosis_details.to_option_diagnosis_details(id, category, category_id, classification, classification_id, sub_classification, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
                    Option_diagnosis_details.update_data(comp);
                    ret_history_sub_classification();
                    Alert.set(2, "");
                }
            });
        ...
        if (col == 2) {
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Option_diagnosis_details.delete_data(to);
                    ret_history_sub_classification();
                    Alert.set(3, "");
                }
            });
