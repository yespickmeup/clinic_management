 ...
 * @author Guinness
 */
public class Dlg_report_sickness_certificate extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_report_sickness_certificate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_sickness_certificate(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_report_sickness_certificate() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_sickness_certificate myRef;

    private void setThisRef(Dlg_report_sickness_certificate myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_sickness_certificate> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_sickness_certificate create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_sickness_certificate create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_sickness_certificate dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_sickness_certificate((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_sickness_certificate((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_sickness_certificate dialog = Dlg_report_sickness_certificate.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jLabel42.setText("is suffering from");
        ...
        jLabel46.setText("He/She was advised to take bed rest for");
        ...
        jLabel48.setText("days, and also regular");
        ...
        jLabel49.setText(" treatment and followup.");
...
//                btn_0.doClick();
    ...
    private void init_report() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String days = "" + FitIn.toInt(jTextField37.getText());
                ...
                InputStream is = Srpt_sickness_certificate.class.getResourceAsStream(jrxml);
                try {
                    ...
                    Logger.getLogger(Dlg_report_sickness_certificate.class.getName()).
    ...
    private void report_sales_items(final Srpt_sickness_certificate to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_expenses(Srpt_sickness_certificate to, String rpt_name) {
        try {
