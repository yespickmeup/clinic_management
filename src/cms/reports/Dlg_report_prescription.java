 ...
 * @author Guinness
 */
public class Dlg_report_prescription extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_report_prescription(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_prescription(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_report_prescription() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_prescription myRef;

    private void setThisRef(Dlg_report_prescription myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_prescription> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_prescription create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_prescription create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_prescription dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_prescription((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_prescription((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_prescription dialog = Dlg_report_prescription.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    private void init_report() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String complaints = "" + to.complaints;

                String history = "" + to.past_personal_family_history;
                String investigation = to.investigation;
                List<Srpt_case_report.field> fields = new ArrayList();
                ...
                for (Out_patient_department_prescriptions.to_out_patient_department_prescriptions med : prescriptions) {
                    double qty = med.qty;
                    String item_code = med.item_code;
                    String description = med.description;
                    String dosage = med.dosage;
                    double days = med.days;
                    double total = med.qty * med.dosage_qty;
                    String dosage_remarks = med.dosage_remarks;
                    Srpt_case_report.field f = new Srpt_case_report.field(qty, item_code, description, dosage, days, total, dosage_remarks);
                    fields.add(f);
                }
                Srpt_case_report rpt = new Srpt_case_report(clinic_name, clinic_address, clinic_contact_no, patient_id, patient_name, bday, age, gender, allergy_drug, allergy_others, blood_group, height, weight, temperature, bp, pulse, respiratory, spo2, is_smoking, is_alcohol, is_drugs, complaints, history, investigation);
                rpt.fields.addAll(fields);
                String jrxml = "rpt_prescription_report.jrxml";
                ...
                try {
                    ...
                    Logger.getLogger(Dlg_report_prescription.class.getName()).
    ...
    private void report_sales_items(final Srpt_case_report to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_expenses(Srpt_case_report to, String rpt_name) {
        try {
            if (to.fields.isEmpty()) {
