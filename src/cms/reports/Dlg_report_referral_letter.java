    ...
    private void init_report() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Srpt_referring_certificate rpt = new Srpt_referring_certificate(clinic_name, clinic_address, clinic_contact_no, patient_id, patient_name, sname, refer_to, findings, doctor, doctor_id, date);
