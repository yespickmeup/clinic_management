...
import cms.degrees.Degrees.to_degrees;
 ...
 * @author Guinness
 */
public class Dlg_degrees extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_degrees(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_degrees(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_degrees myRef;

    private void setThisRef(Dlg_degrees myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_degrees> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_degrees create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_degrees create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_degrees dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_degrees((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_degrees((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_degrees dialog = Dlg_degrees.create(new javax.swing.JFrame(), true);
