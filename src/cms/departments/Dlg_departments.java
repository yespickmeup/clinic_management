...
//                btn_0.doClick();
    ...
    public static void init_tbl_departments(JTable tbl_departments) {
        ...
        int[] tbl_widths_departments = {100, 50, 30, 30, 0, 0, 0, 0};
        ...
        tbl_departments.getColumnModel().getColumn(2).setCellRenderer(new ImageRenderer());
        tbl_departments.getColumnModel().getColumn(3).setCellRenderer(new ImageRenderer());
    }

    public static void loadData_departments(List<Departments.to_departments> acc) {
    ...
    public static class TbldepartmentsModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Department", "Status", "", "", "created_at", "updated_at", "status", "is_uploaded"
        };
    ...
    private void new_departments() {
        jTextField3.setText("");
        tbl_departments.clearSelection();
    ...
    private void save_department() {
        ...
        if (row < 0) {
            ...
            int status = 0;
            int is_uploaded = 0;
            Departments.to_departments depa = new Departments.to_departments(id, department, created_by, updated_by, created_at, updated_at, status, is_uploaded);
            ...
            Departments.to_departments to = (Departments.to_departments) tbl_departments_ALM.get(row);
            int id = to.id;
            String department = jTextField3.getText();
    ...
    private void select_department() {
        ...
        Departments.to_departments to = (Departments.to_departments) tbl_departments_ALM.get(row);
        int col = tbl_departments.getSelectedColumn();
        if (col == 2) {
