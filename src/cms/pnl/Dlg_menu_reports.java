...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cms/icons/invoice (1).png"))); // NOI18N
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ok("Receipt Report", jLabel7);
    }//GEN-LAST:event_jLabel7MouseClicked

    private void jLabel7MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseEntered
        label("Receipt Report", jLabel7);
    ...
    private void set_previledge() {
        ...
        for (User_priveleges.to_user_priveleges to : datas) {
            ...
            if (to.privelege.equalsIgnoreCase("Receipts - (Report)")) {
