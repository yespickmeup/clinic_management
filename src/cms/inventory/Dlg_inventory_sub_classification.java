 ...
 * @author Guinness
 */
public class Dlg_inventory_sub_classification extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_inventory_sub_classification(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_inventory_sub_classification(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_inventory_sub_classification() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_inventory_sub_classification myRef;

    private void setThisRef(Dlg_inventory_sub_classification myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_inventory_sub_classification> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_inventory_sub_classification create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_inventory_sub_classification create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_inventory_sub_classification dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_inventory_sub_classification((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_inventory_sub_classification((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_inventory_sub_classification dialog = Dlg_inventory_sub_classification.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    public static void loadData_degrees(List<Inventory_sub_classifications.to_inventory_sub_classifications> acc) {
    ...
    public static class TbldegreesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Sub-Class", "Status", "", "", "created_at", "updated_at", "status", "is_uploaded"
        };
        ...
        public Object getValueAt(int row, int col) {
            Inventory_sub_classifications.to_inventory_sub_classifications tt = (Inventory_sub_classifications.to_inventory_sub_classifications) getRow(row);
            switch (col) {
                case 0:
    ...
    private void ret_degrees() {
        String where = "";
        List<Inventory_sub_classifications.to_inventory_sub_classifications> datas = Inventory_sub_classifications.ret_data(where);
    ...
    private void save_degree() {
        ...
        if (row < 0) {
            ...
            int status = 0;
            int is_uploaded = 0;
            Inventory_sub_classifications.to_inventory_sub_classifications degr = new Inventory_sub_classifications.to_inventory_sub_classifications(id, degree, clinic,clinic_id,created_by, updated_by, created_at, updated_at, status, is_uploaded);
            ...
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Inventory_sub_classifications.add_data(degr);
                    ret_degrees();
                    new_degree();
                    Alert.set(1, "");
                }
            ...
            Inventory_sub_classifications.to_inventory_sub_classifications to = (Inventory_sub_classifications.to_inventory_sub_classifications) tbl_degrees_ALM.get(row);
            int id = to.id;
            String degree = jTextField3.getText();
           ...
           Inventory_sub_classifications.to_inventory_sub_classifications degr = new Inventory_sub_classifications.to_inventory_sub_classifications(id, degree,clinic,clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
            ...
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Inventory_sub_classifications.update_data(degr);
                    ret_degrees();
                    new_degree();
                    Alert.set(2, "");
                }
    ...
    private void select_degree() {
        ...
        if (col == 2) {
            jTextField3.setText(to.sub_classification);
        }
        if (col == 3) {
            Window p = (Window) this;
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Inventory_sub_classifications.delete_data(to);
                    ret_degrees();
                    new_degree();
                    Alert.set(3, "");
                }
