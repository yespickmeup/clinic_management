...
//                btn_0.doClick();
    ...
    public static void loadData_degrees(List<Inventory_categories.to_inventory_categories> acc) {
    ...
    public static class TbldegreesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Category", "Status", "", "", "created_at", "updated_at", "status", "is_uploaded"
        };
        ...
        public Object getValueAt(int row, int col) {
            Inventory_categories.to_inventory_categories tt = (Inventory_categories.to_inventory_categories) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.category;
                case 1:
    ...
    private void ret_degrees() {
        String where = "";
        List<Inventory_categories.to_inventory_categories> datas = Inventory_categories.ret_data(where);
    ...
    private void save_degree() {
        ...
        if (row < 0) {
            ...
            int status = 0;
            int is_uploaded = 0;
            Inventory_categories.to_inventory_categories degr = new Inventory_categories.to_inventory_categories(id, degree,clinic,clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
            ...
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Inventory_categories.add_data(degr);
                    ret_degrees();
                    new_degree();
                    Alert.set(1, "");
                }
            ...
            Inventory_categories.to_inventory_categories to = (Inventory_categories.to_inventory_categories) tbl_degrees_ALM.get(row);
            int id = to.id;
            String degree = jTextField3.getText();
            ...
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Inventory_categories.update_data(degr);
                    ret_degrees();
                    new_degree();
                    Alert.set(2, "");
                }
    ...
    private void select_degree() {
        ...
        if (col == 2) {
            jTextField3.setText(to.category);
        }
        if (col == 3) {
            Window p = (Window) this;
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Inventory_categories.delete_data(to);
                    ret_degrees();
                    new_degree();
                    Alert.set(3, "");
                }
