 ...
 * @author Guinness
 */
public class Dlg_inventory_models extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_inventory_models(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_inventory_models(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_inventory_models myRef;

    private void setThisRef(Dlg_inventory_models myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_inventory_models> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_inventory_models create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_inventory_models create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_inventory_models dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_inventory_models((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_inventory_models((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_inventory_models dialog = Dlg_inventory_models.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    public static void loadData_degrees(List<Inventory_models.to_inventory_models> acc) {
    ...
    public static class TbldegreesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Model", "Status", "", "", "created_at", "updated_at", "status", "is_uploaded"
        };
        ...
        public Object getValueAt(int row, int col) {
            Inventory_models.to_inventory_models tt = (Inventory_models.to_inventory_models) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.model;
                case 1:
    ...
    private void ret_degrees() {
        String where = "";
        List<Inventory_models.to_inventory_models> datas = Inventory_models.ret_data(where);
    ...
    private void save_degree() {
        ...
        if (row < 0) {
            ...
            int status = 0;
            int is_uploaded = 0;
            Inventory_models.to_inventory_models degr = new Inventory_models.to_inventory_models(id, degree,clinic,clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
            ...
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Inventory_models.add_data(degr);
                    ret_degrees();
                    new_degree();
                    Alert.set(1, "");
                }
           ...
           Inventory_models.to_inventory_models to = (Inventory_models.to_inventory_models) tbl_degrees_ALM.get(row);
            int id = to.id;
            String degree = jTextField3.getText();
            ...
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Inventory_models.update_data(degr);
                    ret_degrees();
                    new_degree();
                    Alert.set(2, "");
                }
        ...
        if (col == 3) {
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Inventory_models.delete_data(to);
                    ret_degrees();
                    new_degree();
                    Alert.set(3, "");
                }
