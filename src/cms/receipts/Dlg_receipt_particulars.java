 ...
 * @author Guinness
 */
public class Dlg_receipt_particulars extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_receipt_particulars(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_receipt_particulars(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_receipt_particulars() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_receipt_particulars myRef;

    private void setThisRef(Dlg_receipt_particulars myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_receipt_particulars> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_receipt_particulars create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_receipt_particulars create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_receipt_particulars dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_receipt_particulars((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_receipt_particulars((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_receipt_particulars dialog = Dlg_receipt_particulars.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    public static void init_tbl_degrees(JTable tbl_degrees) {
        ...
        int[] tbl_widths_degrees = {100, 80, 50, 30, 30, 0, 0, 0};
        ...
        TableWidthUtilities.setColumnRightRenderer(tbl_degrees, 1);
    }

    public static void loadData_degrees(List<Receipt_particulars.to_receipt_particulars> acc) {
    ...
    public static class TbldegreesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Degree", "Amount", "Status", "", "", "updated_at", "status", "is_uploaded"
        };
        ...
        public Object getValueAt(int row, int col) {
            Receipt_particulars.to_receipt_particulars tt = (Receipt_particulars.to_receipt_particulars) getRow(row);
            switch (col) {
                case 0:
    ...
    private void ret_degrees() {
        String where = "";
        List<Receipt_particulars.to_receipt_particulars> datas = Receipt_particulars.ret_data(where);
    ...
    private void save_degree() {
        ...
        if (row < 0) {
            ...
            double charge = FitIn.toDouble(jTextField4.getText());
            ...
            int status = 0;
            int is_uploaded = 0;
            Receipt_particulars.to_receipt_particulars parti = new Receipt_particulars.to_receipt_particulars(id, particular, charge, clinic, clinic_id, created_by, updated_by, created_at, updated_at, status, is_uploaded);
            ...
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Receipt_particulars.add_data(parti);
                    ret_degrees();
                    new_degree();
                    Alert.set(1, "");
                }
            ...
            Receipt_particulars.to_receipt_particulars to = (Receipt_particulars.to_receipt_particulars) tbl_degrees_ALM.get(row);
            int id = to.id;
            String particular = jTextField3.getText();
            double charge = FitIn.toDouble(jTextField4.getText());
            ...
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Receipt_particulars.update_data(parti);
                    ret_degrees();
                    new_degree();
                    Alert.set(2, "");
                }
    ...
    private void select_degree() {
        ...
        if (col == 3) {
            jTextField3.setText(to.particular);
            jTextField4.setText(FitIn.fmt_wc_0(to.charge));
        }
        if (col == 4) {
            Window p = (Window) this;
            ...
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Receipt_particulars.delete_data(to);
                    ret_degrees();
                    new_degree();
                    Alert.set(3, "");
                }
